...
<div class="header">
            ...
            <ul class="nav navbar-nav">
					...
					<li><a href="../function_attendance/student_attendance.php"><span class="glyphicon glyphicon-check">
					  </span> Attendance Check</a></li>
            </ul>
...
<div class="alert alert-danger">
  <strong><span class="glyphicon glyphicon-remove"></span> Error!</strong> Duplicate Entry for this student's section!
</div>
